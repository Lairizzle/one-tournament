export async function onRequestGet({ params, env }) {
  ...
  return Response.json({
    ...
    competitor_a: { id: match.competitor_a_id, name: match.competitor_a_name, pool: aPool, odds: aPool ? (total * 0.9) / aPool : null },
    competitor_b: { id: match.competitor_b_id, name: match.competitor_b_name, pool: bPool, odds: bPool ? (total * 0.9) / bPool : null },
